  ...
  template: `
    <div class="email-generator-container">
      <div class="form-section">
        ...
        <div class="form-group">
          <label for="comentariosGerais">Comentários Gerais (Observações Especiais):</label>
          <textarea 
            id="comentariosGerais"
            [(ngModel)]="comentariosGerais"
            placeholder="Digite aqui comentários que se aplicam a todo o relatório..."
            rows="4"
            class="form-control">
          </textarea>
          <small class="form-text">Estes comentários aparecerão em uma seção destacada no relatório. Deixe vazio se não precisar.</small>
        </div>
        ...
        <div class="portfolios-section">
          ...
          @for (portfolio of portfolios(); track portfolio.name) {
            <div class="portfolio-form">
              ...
              <div class="form-group">
                <label>Comentários Específicos desta Carteira:</label>
                <textarea 
                  [(ngModel)]="portfolio.comentarios"
                  placeholder="Digite comentários específicos para esta carteira (opcional)..."
                  rows="3"
                  class="form-control">
                </textarea>
                <small class="form-text">Comentários específicos aparecerão apenas para esta carteira.</small>
              </div>
...
export class EmailGeneratorComponent {
  ...
  generateEmail(): void {
    const config: EmailConfiguration = {
      ...
      comentariosGerais: this.comentariosGerais() || undefined,
